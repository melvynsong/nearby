  ...
  return (
    <main className="min-h-screen bg-[#f5f6f8] pb-24">
      ...
      <div className="nearby-shell mx-auto w-full max-w-3xl px-4 pt-6">
        ...
        {/* Hero */}
        <div className="mb-6">
          <div className="text-xs font-bold uppercase tracking-widest text-yellow-600 mb-1">Food Showcase</div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-neutral-900 leading-tight mb-2">Top {displayTitle} Places</h1>
          <div className="text-base text-neutral-600 mb-3 max-w-xl">This showcase is curated from real group recommendations and places people actually revisit. Explore the best {displayTitle} in Singapore.</div>
          <Link href="/nearby/showcase" className="inline-flex items-center gap-2 rounded-full bg-yellow-400 text-yellow-900 font-semibold px-5 py-2 shadow hover:bg-yellow-300 transition">← Back to Showcases</Link>
        </div>
